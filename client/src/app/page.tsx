            ...
            <div className="flex relative float-right">
              ...
              <div className="relative text-sm">
                ...
                <button id="userButton" className="flex items-center mr-3 shadow bg-yellow-700 hover:bg-yellow-500 focus:shadow-outline focus:outline-none text-white text-sm md:text-base font-bold py-2 px-4 rounded">
                  Menu
                  <svg className="pl-2 h-2 fill-current text-white" version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 129 129" xmlnsXlink="http://www.w3.org/1999/xlink" enable-background="new 0 0 129 129">
                    <g>
                ...
                <div id="userMenu" className="bg-white rounded shadow-md mr-2 absolute mt-12 top-0 right-0 min-w-full overflow-auto z-30 invisible">
      ...
      <div className="container w-full flex flex-wrap mx-auto px-2 pt-8 lg:pt-16 mt-16">
        ...
        <section className="w-full lg:w-4/5">
          ...
          <div className="p-8 mt-6 lg:mt-0 leading-normal rounded shadow bg-white">
            <li>Using the CDN version of <a className="underline text-yellow-600" href="https://github.com/tailwindcss/custom-forms" alt="" target="_blank">Tailwind Custom Forms</a></li>
          ...
          <div id='section3' className="p-8 mt-6 lg:mt-0 rounded shadow bg-white">
            ...
            <form>
              ...
              <div className="md:flex mb-6">
                <div className="md:w-1/3">
                  <label className="block text-gray-600 font-bold md:text-left mb-3 md:mb-0 pr-4" htmlFor="my-multiselect">
                    Multi Select
                  </label>
                </div>
                <div className="md:w-2/3">
          ...
          <div id='section4' className="p-8 mt-6 lg:mt-0 rounded shadow bg-white">
            ...
            <form>
              ...
              <div className="md:flex mb-6">
                <div className="md:w-1/3">
                  <label className="block text-gray-600 font-bold md:text-left mb-3 md:mb-0 pr-4" htmlFor="my-checkbox">
                    Checkboxes
                  </label>
                </div>
                <div className="md:w-2/3">
